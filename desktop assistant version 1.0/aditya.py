...
newVoiceRate = 170  # greater value = more speed 
...
MASTER = input("Hey! Please Enter your name:-\n")
...
def wishme():
    ...
    print(f'\nI am your desktop assistant....How may i help you ?\n'+MASTER)
    speak(f'I am your desktop assistant....How may i help you ?'+MASTER)
...
def trans():
    speak('Tell me the sentence which you wants to translate from Hindi to English ?')
    line=takehindi()
    a=Translator()
    b=a.translate(line)
    c=b.text
    speak(f'The translation of the {line} is {c}')
...
def tellDay():
    ...
    if day in day_dict.keys():
        ...
        print("\nThe day of the week is ",day_of_the_week)
        speak("The day of the week is " + day_of_the_week)
...
def play():
    ...
    try:
        os.startfile('D:\\')
        folder=takeCommand()
        playsound('D:\\Songs\\Sample.mp3')
        os.startfile('D:\\Songs'+folder)
        speak('Tell me the name of song or video')
        name=takeCommand()
        os.startfile('D:\\'+folder+'name'+'.mp3')
    except:
...
def whatsapp():
    ...
    if 'nakul' in name.lower():
        ...
        min=int(takeCommand())
        pywhatkit.sendwhatmsg('+91 9208706362',msg,hour,min)
        keyboard.press(Key.enter)
        keyboard.release(Key.enter)
        speak(f'ok! sir sending message to {name}')

    elif 'yogesh' in name.lower():
        speak('tell me the message!')
        msg=takeCommand()
        speak('tell the time sir!')
        speak('time in hours!')
        ...
        speak('time in minute')
        min=int(takeCommand())
        pywhatkit.sendwhatmsg('+91 9784879090',msg,hour,min)
        keyboard.press(Key.enter)
        keyboard.release(Key.enter)
        speak(f'ok! sir sending message to {name}')

    elif 'mom' in name.lower() or 'home' in name.lower() or 'mother' in name.lower(): 
        speak('tell me the message!')
        msg=takeCommand()
        speak('tell the time sir!')
        speak('time in hours!')
        ...
        speak('time in minute')
        min=int(takeCommand())
        pywhatkit.sendwhatmsg('+91 8449440390',msg,hour,min)
        keyboard.press(Key.enter)
        keyboard.release(Key.enter)
        speak(f'ok! sir sending message to {name}')   
...
def screenshot():
    ...
    p=takeCommand()
    path=p+'.png'
    path1='D:\\extra\\Projects-master\\desktop assistant version 1.0\\'+path
...
def openapps(query):
    ...
    if 'open anydesk' in query.lower() or 'open any desk' in query.lower():
        ...
        os.startfile("C:\\Program Files (x86)\\AnyDesk.exe")

    elif 'VS Studio code' in query.lower() or 'VS' in query.lower():
        speak('opening VS Studio Code')
        os.startfile("C:\\Users\\adity\\AppData\\Roaming\\Microsoft\\Windows\\Start Menu\\Programs\\Visual Studio Code.exe")  
    ...
    elif 'open android' in query.lower() or 'open android studio' in query.lower():
        speak('opening Android studio')
        os.startfile("C:\\ProgramData\\Microsoft\\Windows\\Start Menu\\Programs\\Android Studio.exe")
        keyboard.press(Key.enter)
        keyboard.release(Key.enter)
        ...
        speak('opening Pycharm by Jet Brains ')
        os.startfile('C:\\ProgramData\\Microsoft\\Windows\\Start Menu\\Programs\\JetBrains\\PyCharm Community Edition 2022.1.2.exe')  

    elif 'open Intellij Idea' in query.lower() or 'open Intellij' in query.lower():
        speak('opening Intellij Idea by Jet Brains')
        os.startfile('C:\\ProgramData\\Microsoft\\Windows\\Start Menu\\Programs\\JetBrains\\IntelliJ IDEA Community Edition 2022.1.2.exe')
        ...
        os.startfile("C:\\Program Files\\Google\\Chrome\\Application.exe")    
        ...
        os.startfile("C:\\Program Files\\WindowsApps\\Microsoft.WindowsNotepad_11.2208.25.0_x64__8wekyb3d8bbwe\\Notepad")
        ...
        os.startfile("C:\\Qt\\Tools\\QtDesignStudio\\bin\\qtdesignstudio.exe")    
        ...
        os.startfile('C:\\Users\\adity\\AppData\\Roaming\\Microsoft\\Windows\\Start Menu\\Programs\\Microsoft Teams (work or school).exe')
    ...
    elif 'open moodle' in query.lower() or 'open KIET portal' in query.lower() or 'open KIET moodle' in query.lower():
        speak("that's my home...haha jokes apart")
        speak('opening KIET moodle')
    ...
    elif 'open music' in query.lower() or 'open media player' in query.lower():
        speak('opening VLC music player')
        os.startfile("C:\\ProgramData\\Microsoft\\Windows\\Start Menu\\Programs\\VideoLAN.exe")    


    elif 'open uml' in query.lower() or 'open star uml'in query.lower():
        speak('opening star uml')
        os.startfile('C:\\ProgramData\\Microsoft\\Windows\\Start Menu\\Programs\\StarUML.exe')
